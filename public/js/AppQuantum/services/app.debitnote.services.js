(function () {
    ...
    angular
        .module("QuantumApp")
        .service("DebitNoteService", DebitNoteService);

    DebitNoteService.$inject = ['$http', 'SERVER_CONFIG', 'API_ROUTE', 'API_ACTION'];

    function DebitNoteService($http, SERVER_CONFIG, API_ROUTE, API_ACTION) {

        var API_HOST = SERVER_CONFIG.API_HOST + API_ROUTE.DEBITNOTE;
        ...
        {            
            var param = {
                    ...
                    "debitNotePayment[]": entity.debitNotePayment                    
                };
