(function () {
  ...
  angular.module("QuantumApp").controller("ClientController", ClientController);
  ...
  function ClientController(
    ...
    vm.create = function (redir = true) {
      ...
      promise.then(function (pl) {
        ...
        if (redir) window.location = HOST_ROUTE.CLIENT;
        else {
    ...
    vm.edit = function (id, UserRoleId, CompanyId) {
      ...
      promise.then(function (pl) {
        vm.client = pl.data;
        if (vm.client.is_active === 1) vm.toggleSelected = true;
        else vm.toggleSelected = false;
