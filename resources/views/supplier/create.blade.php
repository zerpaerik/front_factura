...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='SupplierController as vm' ng-init="vm.readCompanyList({{$_COOKIE['userRole']}}, {{$_COOKIE['company_id']}})">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmSupplier" novalidate="novalidate" ng-submit="vm.create()">  
