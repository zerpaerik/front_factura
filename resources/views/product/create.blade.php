...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='ProductController as vm' ng-init="vm.readCountryTaxList(28)">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="row">
                        <form class="form-horizontal" name="FrmProduct" novalidate="novalidate" ng-submit="vm.create({{Cookie::get('company_id')}})">  
                            <div class="col-sm-12">
                                <div class="tabs-container">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab-1"> Datos Principales</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-2">Datos Opcionales</a></li>
                                        <li class=""><a data-toggle="tab" href="#tab-3">Impuestos Asociados</a></li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="panel-body">
                                                ...
                                                <div class="form-group col-xs-6">
                                                    ...
                                                    <input id="unit_cost" ng-model="vm.product.unit_cost" type="number" step=".0001" placeholder="Costo unitario" class="form-control">
                                                </div>
                                                ...
                                                <div class="form-group col-xs-6">
                                                    ...
                                                    <input id="max_stock" ng-model="vm.product.max_stock" type="number" placeholder="Stock máximo" class="form-control">
                                                </div>
