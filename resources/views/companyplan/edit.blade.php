...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Editar Plan de Compañía</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='CompanyPlanController as vm' ng-init="vm.edit({{$id}})">
        <div class="row">

            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Editar Plan de Compañía</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal" name="FrmCompany" novalidate="novalidate" ng-submit="vm.update()"> 
                            <input type="hidden" ng-model="vm.companyplan.id">
