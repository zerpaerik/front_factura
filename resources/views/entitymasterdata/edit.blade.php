...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Editar Datos Maestros</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="EntityMasterDataController as vm" ng-init="vm.edit({{$id}})">
        <div class="row">

            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Editar Datos Maestros</h5>
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmEntityMasterData" novalidate="novalidate" ng-submit="vm.update()">
                            <input type="hidden" ng-model="vm.entitymasterdata.id"> 
