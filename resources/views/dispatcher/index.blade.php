...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ url('/supplier')}}">Transportistas</a>
                </li>
                <li class="active">
                    <strong>Listar Transportistas</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div id="dispatcher" class="wrapper wrapper-content animated fadeInRight" ng-controller="DispatcherController as vm">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Lista de Transportistas</h5>
                        <div class="ibox-tools">                                                      
                            <a href="{{url('/dispatcher/create')}}" class="btn btn-xs btn-primary"><span class="fa fa-plus-circle"></span> Nuevo Transportista</a>
                        </div>
                    </div>                    
        ...
        <script>                                             
            ...
            $(document).ready( function () {
                ...
                var apiUrl =  '{{env('API_HOST', NULL)}}/dispatcherDt/' + check; 
                $('#myTable').DataTable({
                    "processing" : false,
                    "serverSide" : true,
                    "language": {
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="{{url("dispatcher/edit")}}/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
            ...
            */
            function deleteElement(id){            
                angular.element(document.getElementById('dispatcher')).scope().vm.delete(id);
            }
