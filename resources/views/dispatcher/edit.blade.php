...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Editar Transportista</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='DispatcherController as vm' ng-init="vm.edit({{$id}}, {{$_COOKIE['userRole']}}, {{$_COOKIE['company_id']}})">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Editar Transportista</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal" name="FrmClient" novalidate="novalidate" ng-submit="vm.update()">  
                            <input type="hidden" ng-model="vm.dispatcher.id">     
                            <div class="form-group"><label class="col-lg-2 col-lg-offset-1 control-label">Compañía</label>
                                <div class="col-lg-6">                                                                    
                                    <select id="company" class="form-control" ng-options="company.name for company in vm.CompanyList track by company.id" ng-model="vm.dispatcher.company" required>
                                    </select>
                                </div>
                            </div>   
