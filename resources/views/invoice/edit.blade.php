                                ...
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        ...
                                        <div class="ibox-tools">
                                            ...
                                            <button type="button" ng-click="vm.createPreInvoice()" class="btn btn-sm btn-warning btn-outline" ng-show="vm.EnableButtons||vm.EnablePreInvoice"><span class="fa fa-desktop"></span> Emitir Proforma</button>     
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select chosen
                                                              data-placeholder="Seleccione Pais Origen"
                                                              no-results-text="'Pais no encontrado'"
                                                              ng-model="vm.sourceCountrySelected"
                                                              ng-options="source.id as source.name for source in vm.SourceCountryList"
                                                              ng-change="vm.selectSourceCountry(vm.sourceCountrySelected)"
                                                              required>
                                                              <option></option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select chosen
                                                              data-placeholder="Seleccione Pais Destino"
                                                              no-results-text="'Pais no encontrado'"
                                                              ng-model="vm.destinationCountrySelected"
                                                              ng-options="destination.id as destination.name for destination in vm.DestinationCountryList"
                                                              ng-change="vm.selectDestinationCountry(vm.destinationCountrySelected)"
                                                              required>
                                                              <option></option>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select chosen
                                                              data-placeholder="Seleccione Pais Adquisición"
                                                              no-results-text="'Pais no encontrado'"
                                                              ng-model="vm.sellerCountrySelected"
                                                              ng-options="seller.id as seller.name for seller in vm.SellerCountryList"
                                                              ng-change="vm.selectSellerCountry(vm.sellerCountrySelected)"
                                                              required>
                                                              <option></option>
                                                        </select>
                                                    </div>
                                            ...
                                            {{-- <div class="col-lg-12"> --}}
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-7 control-label">
                                                        Descuento Solidario 2%:
                                                        <toggle id="is_solidarity_discount" 
                                                                ng-model="vm.solidarityDiscounttoggleSelected" 
                                                                onstyle="btn-success" on="Si" 
                                                                offstyle="btn-danger" off="No"
                                                                ng-change="vm.calculateSolidarityDiscount()">
                                                        </toggle>   
                                                    </label>

                                                    <div class="col-lg-5">
                                                        <input name="solidarityDiscount" disabled="!vm.solidarityDiscounttoggleSelected"  placeholder="" class="form-control" ng-model="vm.Invoice.solidarity_discount" value="@{{vm.Invoice.solidarity_discount | number:2}}">
                                                    </div>
                                                </div>
                                                <br><br>
                                                <div class="form-group">
