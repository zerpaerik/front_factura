...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Lista Notas de Débito</h5>
                        <div class="ibox-tools">                            
                            <a href="{{url('debitnote/create')}}" class="btn btn-xs btn-danger"><span class="fa fa-plus-circle"></span> Nueva Nota de Débito</a>                            
                        </div>
                    </div>                    
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="myTable" aria-describedby="DataTables_Table_0_info" role="grid" >
                                    ...
                                    <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 5%;"><center>F. Nota de Débito</center></th>                                                            
    ...
    <script>                 
        ...
        $(document).ready( function () {
            ...
            let apiUrl =  '{{env('API_HOST', NULL)}}/debitnoteDt/' + check;            
                ...
                'columns'    : [                    
                    ...
                    {data: 'amount',                 className: "text-center"},                    
                    {
                        ...
                        render: function (data){
                            let actions = '';
                            actions += '<center>'                      
                                    + '<a href="{{url('debitnote/createPDF/')}}/'+ data.id +'" target="_blank" class="btn btn-xs btn-warning" title="Generar PDF" style="margin-right:3px"><i class="fa fa-file-pdf-o"></i></a>'
                                    ...
                                    + '<a href="{{url('debitnote/downloadXML')}}/' + data.id +'"  class="btn btn-xs btn-primary" target="_blank" title="Descargar XML" style="margin-right:3px"><i class="fa fa-download"></i></a>';
                            return actions;
                        }
                    }
                ]
        ...
        function sendMail(id){
            swal({
                ...
                text: "El PDF y XML de la nota de debito serán enviados al cliente",
                type: "warning",
                ...
                if (!isConfirm) return;
                $.ajax({
                    url: "{{env('APP_URL', NULL)}}/debitnote/mail/" + id,
                    type: "GET",                                        
                    success: function () {
