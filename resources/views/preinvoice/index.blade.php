...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>Pre-Facturas</strong>
                </li>
            </ol>
        </div>        
    </div>

    <div id="preinvoice" class="wrapper wrapper-content animated fadeInRight" ng-controller="InvoiceController as vm" ng-init="vm.readDocumentPlan({{$_COOKIE['company_id']}})">
    ...
    <script>                        
        $(document).ready( function () {
            ...
            let apiUrl =  '{{env('API_HOST', NULL)}}/preinvoiceDt/' + check; 
