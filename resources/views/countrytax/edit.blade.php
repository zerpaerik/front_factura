...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller='CountryTaxController as vm' ng-init="vm.edit({{$id}})">
        <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal" name="FrmCountryTax" novalidate="novalidate" ng-submit="vm.create()">   
                            <input type="hidden" ng-model="vm.countrytax.id">
