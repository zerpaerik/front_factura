...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ url('/mailConfiguration')}}">Configuración de Correo</a>
                </li>
                <li class="active">
                    <strong>Nueva Configuración de Correo</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="MailConfigurationController as vm" ng-init="vm.init({{Cookie::get('company_id')}})">
        <div class="row">

            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Nueva Configuración de Correo</h5>
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmMailConfig" novalidate="novalidate" ng-submit="vm.create()" >
