    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ url('/mailconfigurtion')}}">Configuración de Correo</a>
                </li>
                <li class="active">
    ...
    <div id="mailconfiguration" class="wrapper wrapper-content animated fadeInRight" ng-controller="MailConfigurationController as vm">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            <a href="{{url('/mailconfiguration/create')}}" class="btn btn-sm btn-primary"><span class="fa fa-plus-circle"></span> Crear Configuración </a>
                        </div>
                    </div>                    
        ...
        <script>
            ...
            @if($_COOKIE['userRole'] == env('ROLE_SUPERADMIN', NULL))
                var apiUrl =  '{{env('API_HOST', NULL)}}/mailconfigurationDtAll';
            @else
                var apiUrl =  '{{env('API_HOST', NULL)}}/mailconfigurationDt/{{$_COOKIE['company_id']}}';
            @endif
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="{{url("mailconfiguration/edit")}}/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
