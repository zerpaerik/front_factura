...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="CompanyController as vm" ng-init="vm.edit({{$id}}); vm.token='{{$_COOKIE['token']}}';">
        <div class="row">

            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Editar Compañía</h5>
                        <div class="ibox-tools">
                        </div>
                    </div>                    

                    <div class="row">
                        <form class="form-horizontal" name="FrmCompany" novalidate="novalidate" ng-submit="vm.update()">
                            <input type="hidden" ng-model="vm.company.id"> 
                            <div class="col-sm-12">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group col-xs-6">
                                                    ...
                                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                        ...
                                                        <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new">Seleccionar Archivo</span><span class="fileinput-exists">Cambiar</span><input type="file" name="..." accept=".p12" ng-model="vm.company.digital_certificate" 
