...
@section('content')
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="PlanController as vm" ng-init="vm.edit({{$id}})">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <br>
                        <form class="form-horizontal" name="FrmPlan" novalidate="novalidate" ng-submit="vm.update()">
                            <input type="hidden" ng-model="vm.plan.id" value="{{$id}}" />
