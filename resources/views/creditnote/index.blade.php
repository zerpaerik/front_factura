...
@section('content')
    ...
    <div class="wrapper wrapper-content animated fadeInRight" ng-controller="CreditNoteController as vm" ng-init="vm.readDocumentPlan({{$_COOKIE['company_id']}})">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools" ng-show="vm.PlanCompany.documentQuantity != vm.PlanCompany.plan.document_count">                            
                            <a href="{{url('creditnote/create')}}" class="btn btn-xs btn-danger"><span class="fa fa-plus-circle"></span> Nueva Nota de Crédito</a>                            
                        </div>
                    </div>                    
