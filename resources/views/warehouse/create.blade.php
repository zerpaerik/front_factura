                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal" name="FrmWarehouse" novalidate="novalidate" ng-submit="vm.update({{$id}})">   
                           @else
                           <form class="form-horizontal" name="FrmWarehouse" novalidate="novalidate" ng-submit="vm.create({{$_COOKIE['company_id']}})">   
                           @endif                  
                            <div class="form-group"><label class="col-lg-2 col-lg-offset-1 control-label">Nombre</label>
                                <div class="col-lg-6"><input id="name" type="text" ng-model="vm.warehouse.name" placeholder="Nombre del almacen" class="form-control" required>
                                </div>
                            </div>
                            
                            <div class="form-group"><label class="col-lg-2 col-lg-offset-1 control-label">Dirección</label>
                                <div class="col-lg-6"><input id="address" type="text" ng-model="vm.warehouse.address" required placeholder="Dirección de almacen" class="form-control">
                                </div>
                            </div>
