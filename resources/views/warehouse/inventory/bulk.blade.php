...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ url('/warehouse/inventory') }}">Inventario</a>
                </li>                
                <li class="active">
    ...
    <div id="inventory" class="wrapper wrapper-content animated fadeInRight" ng-controller="InventoryController as vm" ng-init="vm.loadProducts({{$_COOKIE['company_id']}})">
        <div class="row">            
