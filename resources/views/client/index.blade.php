...
@section('content')
    ...
    <div id="client" class="wrapper wrapper-content animated fadeInRight" ng-controller="ClientController as vm">
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">  
                            <a href="{{url('product/import')}}" class="btn btn-xs btn-primary"><span class="fa fa-file"></span> Importar Clientes</a>                          
                            <a href="{{url('/client/create')}}" class="btn btn-xs btn-danger"><span class="fa fa-plus-circle"></span> Nuevo Cliente</a>
                        </div>
                    </div>                    
        ...
        <script>                                             
            ...
            $(document).ready( function () {
                ...
                var apiUrl =  '{{env('API_HOST', NULL)}}/clientDt/' + check; 
                $('#myTable').DataTable({
                    "processing" : false,
                    "serverSide" : true,
                    "language": {
                    ...
                    'columns'    : [
                        ...
                        },
                        {
                            ...
                            render: function (data){
                                let actions = '';
                                actions += '<center>'
                                         + '<a href="{{url("client/edit")}}/'+data.id+'" class="btn btn-xs btn-default" style="margin-right:3px"><i class="fa fa-pencil"></i></a>'
            ...
            */
            function deleteElement(id){            
                angular.element(document.getElementById('client')).scope().vm.delete(id);
            }
